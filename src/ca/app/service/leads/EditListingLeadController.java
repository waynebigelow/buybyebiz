...
@Controller
public class EditListingLeadController extends BaseController {
	@Autowired
	...
	public ModelAndView handleRequest(HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		json.include("businessName","firstName","lastName","email","telephone","website","promoSent");
		json.exclude("*");
		
		JsonUtil.setupResponseForJSON(response);
		response.getWriter().print(json.serialize("lead", listingLead));
