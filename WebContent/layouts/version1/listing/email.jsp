		...
		<div class="modal-content">
			<form name="emailForm" id="emailForm" class="form-horizontal" role="form">
				...
				<div class="modal-body">
					...
					<div class="form-group">
						<label for="commentText" class="sr-only"><spring:message code="125.lbl.comment"/></label>
						<div class="col-xs-12">
				...
				<div class="modal-footer">
					...
					<button id="sendMailBtn" type="button" class="btn btn-primary"><spring:message code="0.txt.send"/></button>
				</div>
			</form>
		</div>
	</div>
